...
let config = {
    ...
    //mongodb配置信息
    mongodb: {
        uri: 'mongodb://username:password@IpAddress:27017/mobile',
        options: {}
    },
    ...
    title: 'Mobile',
    api: {
        dir: 'mobile/api/v1' //api访问路径，如http://localhost/mobile/api/v1
    },
    homepage: {
        dir: 'mobile',       //前台访问路径，如http://localhost/mobile
    },
    upload: {
